...
//$(document).ready(function(){
	...
	function checkLickStatus(userId,huggaId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/checkLickStatus/"+huggaId+'/'+userId,
	    	async: false,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function checkFlushStatus(userId,huggaId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/checkFlushStatus/"+huggaId+'/'+userId,
	    	async: false,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function updateLickCount(updatedLickCnt,huggaId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/updateLickCount/"+huggaId+'/'+updatedLickCnt,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function updateFlushCount(updatedFlushCnt,huggaId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/updateFlushCount/"+huggaId+'/'+updatedFlushCnt,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function deleteLick(huggaId,userId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/deleteLick/"+huggaId+'/'+userId,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function deleteFlush(huggaId,userId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/deleteFlush/"+huggaId+'/'+userId,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function insertLick(huggaId,userId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/insertLick/"+huggaId+'/'+userId,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
	...
	function insertFlush(huggaId,userId){
		//query db
		$.ajax({
	    	url: "http://localhost/lickflush/insertFlush/"+huggaId+'/'+userId,
	    	async: true,
	    	dataType: 'json',
	    	success: function(response) {
