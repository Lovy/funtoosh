...
<head>
   ...
   <link href="<?php echo assets_url(); ?>plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
   <!-- END THEME STYLES -->
               ...
               <div class="row">
	               ...
	               <div class="portlet">
	                  ...
	                  <div class="portlet-body" id="chats">
	                     <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 435px;"><div class="scroller" style="height: 435px; overflow: hidden; width: auto;" data-always-visible="1" data-rail-visible1="1">
	                        ...
	                        <li class="out"><img class="avatar" alt="" src="assets/img/avatar1.jpg"><div class="message"><span class="arrow"></span><a href="#" class="name">Bob Nilson</a>&nbsp;<span class="datetime">at Wed Mar 26 2014 19:27:01 GMT+0530 (India Standard Time)</span><span class="body">Hello</span></div></li><li class="out"><img class="avatar" alt="" src="assets/img/avatar1.jpg"><div class="message"><span class="arrow"></span><a href="#" class="name">Bob Nilson</a>&nbsp;<span class="datetime">at Wed Mar 26 2014 19:28:58 GMT+0530 (India Standard Time)</span><span class="body">Hello again</span></div></li></ul>
	                     </div><div class="slimScrollBar" style="background-color: rgb(161, 178, 189); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 1px; height: 195.07731958762886px; background-position: initial initial; background-repeat: initial initial;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; background-color: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px; background-position: initial initial; background-repeat: initial initial;"></div></div>
	                     <div class="chat-form">
	            ...
	            <div class="portlet box purple">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-cogs"></i>Media Objects</div>
                     <div class="tools">
