         ...
         <div class="row">
            <div class="col-md-12 blog-page">  	
               <div class="row">
                  ...
                  <div id="huggaContent" class="col-md-6 article-block" style="background-image: url('http://hugde.com/hugde_assets/img/longLoader.gif');background-repeat: no-repeat">
                  	<?php
					foreach($huggas as $item){
					?>
                  	<div class="row">
