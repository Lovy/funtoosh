...
HTML;
            ...
            <?php
               ...
               <ul class="dropdown-menu">
                  <li><a href="http://localhost/home/myhugge"><i class="icon-user"></i> My Hugge</a>
                  </li>
                  ...
                  <div class="col-md-6 article-block">
					...
					?>
                     ...
                     <div class="blog-tag-data">
                     	<a href="<?php echo base_url().'hugga/'.$item['huggaId']; ?>"><img src="<?php echo $item['images'][0]['mediumUrl']; ?>" class="img-responsive" alt="" style="width:100%"></a>
                        <div class="row">
                           <div class="col-md-2">
