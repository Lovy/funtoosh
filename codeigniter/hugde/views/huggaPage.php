					...
					?>
                  	<div class="row">
                  		<div class="col-md-12">
                  			...
                  			<a href="javascript:void(0)" onclick="javascript:onclicknext(<?php echo $item['huggaId']; ?>,<?php echo $data['userId']; ?>);" class="btn blue pull-right" >Next <i class=" icon-chevron-right"></i></a>
